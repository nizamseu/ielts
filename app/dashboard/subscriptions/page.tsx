  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Manage Subscriptions</h2>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">View active organizations and user billing plans.</p>
        </div>
      </div>
